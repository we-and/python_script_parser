...
NUITKA_DIST_DIR="nuitka_dist111multi_signed/x64"
APP_NAME="scripti"
...
/usr/local/bin/python3 -m nuitka  --standalone --macos-create-app-bundle  --follow-imports scripti.py --include-data-dir=examples=examples --include-data-dir=icons=icons --noinclude-data-file=tcl/opt0.4 --noinclude-data-file=tcl/http1.0 --enable-plugin=tk-inter  --include-module=pandas --macos-disable-console --macos-app-icon=$ICON_FILE --output-dir=$NUITKA_DIST_DIR --macos-sign-identity='Developer ID Application: WeAnd Ltd (3UCPV3W9SM)' --macos-sign-notarization   --macos-signed-app-name="uk.co.weand.scriptparser" --noinclude-data-file=tcl/opt0.4 --noinclude-data-file=tcl/http1.0 
